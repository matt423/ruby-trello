...
describe OAuthPolicy do
  ...
  context '2-legged' do
    ...
    it 'preserves query parameters' do
      ...
      allow(Clock).to receive(:timestamp).and_return '1327048592'
      allow(Nonce).to receive(:next).and_return 'b94ff2bf7f0a5e87a326064ae1dbb18f'
    ...
    it 'adds correct signature for uri with parameters' do
      allow(Clock).to receive(:timestamp).and_return '1327351010'
      allow(Nonce).to receive(:next).and_return 'f5474aaf44ca84df0b09870044f91c69'
    ...
    it 'can sign with token' do
      allow(Clock).to receive(:timestamp).and_return '1327360530'
      allow(Nonce).to receive(:next).and_return '4f610cb28e7aa8711558de5234af1f0e'
