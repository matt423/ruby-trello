  ...
  describe Notification do
    ...
    context "finding" do
      ...
      it "can find a specific notification" do
        allow(client).to receive(:get).with("/notifications/#{notification_details['id']}", {}).and_return notification_payload
    ...
    context "boards" do
      it "can retrieve the board" do
        allow(client).to receive(:get).with("/notifications/#{notification_details['id']}/board").and_return JSON.generate(boards_details.first)
    ...
    context "lists" do
      it "can retrieve the list" do
        allow(client).to receive(:get).with("/notifications/#{notification_details['id']}/list").and_return JSON.generate(lists_details.first)
    ...
    context "cards" do
      it "can retrieve the card" do
        allow(client).to receive(:get).with("/notifications/#{notification_details['id']}/card").and_return JSON.generate(cards_details.first)
    ...
    context "members" do
      it "can retrieve the member" do
        allow(client).to receive(:get).with("/notifications/#{notification_details['id']}/member").and_return user_payload
        expect(notification.member.id).to eq(user_details['id'])
      end

      it "can retrieve the member creator" do
        allow(client).to receive(:get).with("/members/#{user_details['id']}", {}).and_return user_payload
    ...
    context "organization" do
      it "can retrieve the organization" do
        allow(client).to receive(:get).with("/notifications/#{notification_details['id']}/organization").and_return JSON.generate(orgs_details.first)
